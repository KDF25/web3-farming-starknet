...
from database.main import all_wallets_to_deploy, current_wallet
from modules.account import one_account_deploy

logger.remove()
custom_name = "MAIN Deploy"
...
async def one_wallet_deploy(wallet: dict, index: int):
    ...
    await one_account_deploy(wallet=wallet, index=index)
